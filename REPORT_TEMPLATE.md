...
* Calories (kcal) = weight × distance × 1.036 (a general factor for running) 
    * *Source:* [Best Running Tips](https://www.best-running-tips.com/calories-burned-calculator.html#gsc.tab=0)
...
I chose these ranges based on the Compendium of Physical Activities, which classifies running intensity by speed and pace, and also based on my own experience. [Compendium Source](https://pacompendium.com/running/)
...
* I picked a hover effect from the options provided and adjusted it
...
From this assignment, I learned how to use variables to store user input and apply conditional logic (if/else) to make decisions based on different results. I finally understood the Input → Process → Output flow — how data enters through HTML, gets processed in JavaScript, and is displayed back to the user. I also realized that programming is not just writing code, but testing, making mistakes, and fixing them step by step. I know I'm still at the beginning and need much more practice, but I'm excited to keep learning through AI, YouTube, different websites and my own experiments
